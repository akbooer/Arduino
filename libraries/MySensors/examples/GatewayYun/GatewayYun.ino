 ...
 *
 * Modified Sept 2015 by AKBooer to operate on a Yun processor
 * Note two modes of operation:
 *   server.listenOnLocalhost ();    // only available to Atheros processor on Yun board
 *   server.noListenOnLocalhost ();  // available to external IP addresses
 *
 * 
 * DESCRIPTION
